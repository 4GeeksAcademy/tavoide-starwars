                    ...
                    <div className=" bg-warning " key={index}>
                        <div className="card" >
                            ...
                            <div className="card-body bg-secondary d-flex">
                                <button className="btn btn-primary  mx-4" onClick={() => handlerMoreDetails(people.uid)}>Detalles</button>
                                <button className="btn btn-sm border border-danger rounded" onClick={() => handlerFav(people)}>
